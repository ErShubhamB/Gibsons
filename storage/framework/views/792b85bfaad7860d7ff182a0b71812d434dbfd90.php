                        ...
                        <div class='row-filter-combo row'>
                          ...
                          <div class='col-sm-3'>
                            <select name='filter_column[<?php echo e($col["field_with"]); ?>][type]' data-type='<?php echo e($col["type_data"]); ?>' class="filter-combo form-control">
                              ...
                              <?php if(in_array($col['type_data'],['int','integer','double','float','decimal'])): ?><option <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == '>=')?"selected":""); ?> value='>='><?php echo e(trans("crudbooster.filter_greater_than_or_equal")); ?></option><?php endif; ?>
                              <?php if(in_array($col['type_data'],['int','integer','double','float','decimal'])): ?><option <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == '<=')?"selected":""); ?> value='<='><?php echo e(trans("crudbooster.filter_less_than_or_equal")); ?></option><?php endif; ?>
                              <?php if(in_array($col['type_data'],['int','integer','double','float','decimal'])): ?><option <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == '<')?"selected":""); ?> value='<'><?php echo e(trans("crudbooster.filter_less_than")); ?></option><?php endif; ?>
                              <?php if(in_array($col['type_data'],['int','integer','double','float','decimal'])): ?><option <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == '>')?"selected":""); ?> value='>'><?php echo e(trans("crudbooster.filter_greater_than")); ?></option><?php endif; ?>
                            ...
                            <div class='row between-group' style="<?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == 'between')?"display:block":"display:none"); ?>">
                              <div class='col-sm-6'>
                                <div class='input-group'>
                                  ...
                                  type='text' 
                                  class='filter-value-between form-control <?php echo e((in_array($col["type_data"],["date","time","datetime","timestamp"]))?"datepicker":""); ?>' readonly placeholder='<?php echo e($col["label"]); ?> <?php echo e(trans("crudbooster.filter_from")); ?>' name='filter_column[<?php echo e($col["field_with"]); ?>][value][]' value='<?php
                              ...
                              <div class='col-sm-6'>
                                <div class='input-group'>
                                  ...
                                  type='text' 
                                  class='filter-value-between form-control <?php echo e((in_array($col["type_data"],["date","time","datetime","timestamp"]))?"datepicker":""); ?>' readonly placeholder='<?php echo e($col["label"]); ?> <?php echo e(trans("crudbooster.filter_to")); ?>' name='filter_column[<?php echo e($col["field_with"]); ?>][value][]' value='<?php
                                  $value = CRUDBooster::getValueFilter($col["field_with"]); 
