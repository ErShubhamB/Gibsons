...
<li class="dropdown">
	<a href="" class="dropdown-toggle no-after peers fxw-nw ai-c lh-1" data-toggle="dropdown">
		<div class="peer mR-10">
			...
			<img class="w-2r bdrs-50p" src="/uploads/<?php echo e(Auth::user()->avatar); ?>" alt="">
			
			<?php else: ?>
			<img class="w-2r bdrs-50p" src="https://www.winhelponline.com/blog/wp-content/uploads/2017/12/user.png" alt="">
			<?php endif; ?>
			</div>
			<div class="peer">
				<span class="fsz-sm c-grey-900 d-none d-sm-block"><?php echo e(Auth::user()->name); ?></span>
			</div>
		</a>
		<ul class="dropdown-menu fsz-sm">
			
			<li>
				<a href="<?php echo e(route('user-profile')); ?>" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700">
