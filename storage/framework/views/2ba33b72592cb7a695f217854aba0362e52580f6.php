<?php $__env->startSection('content'); ?>	 
            ...
            <script>
              ...
              <p align="right"><a title='Add Field Setting' class='btn btn-sm btn-primary' href='<?php echo e(route("SettingsControllerGetAdd")."?group_setting=".$page_title); ?>'><i class='fa fa-plus'></i> Add Field Setting</a></p>
                          ...
                          <div class="box-body">
                                  ...
                                  <div class='form-group'>
                                      <label class='label-setting' title="<?php echo e($s->name); ?>"><?php echo e($s->label); ?> 
                                          <a style="visibility:hidden" href='<?php echo e(CRUDBooster::mainpath("edit/$s->id")); ?>' title='Edit This Meta Setting' class='btn btn-box-tool'><i class='fa fa-pencil'></i></a> 
