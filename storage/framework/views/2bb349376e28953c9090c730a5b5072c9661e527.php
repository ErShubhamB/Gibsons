...
<div class="container">
    ...
    background: url(<?php echo e(Session::get('user_avatar')); ?>);"></div>
    			<div class="seperator" width="250" height="60"></div>
                <div class="avatar">
                    <img src="/uploads/<?php echo e(Auth::user()->avatar); ?>" alt="" id="profile_img"/>
                </div>
                <div class="content">
			  ...
			  <div class="panel-body">
                <form role="form" onsubmit="return false;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Your Name" name="name" required autofocus value="<?php echo e(Auth::user()->name); ?>">
                        </div>
                        <div class="form-group">
                            <label class="text-normal text-dark">Email</label>
                            <input type="email" class="form-control" placeholder="name@email.com" name="email" required value="<?php echo e(Auth::user()->email); ?>">
                            </div>
                            <div class="form-group">
