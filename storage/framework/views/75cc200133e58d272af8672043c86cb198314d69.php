...
<ul class="nav nav-tabs">
  ...
  <li role="presentation" class="active"><a href="<?php echo e(Route('ModulsControllerGetStep3',['id'=>$id])); ?>"><i class='fa fa-plus-square-o'></i> Step 3 - Form Display</a></li>
...
<div class="box box-default">
    ...
    <form method="post" autocomplete="off" action="<?php echo e(Route('ModulsControllerPostStep4')); ?>">
        ...
        <table class='table-form table table-striped'>
        	...
        	<tbody>
                <?php $index = 0;?>
        		<?php $__currentLoopData = $cb_form; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $form): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        		<tr>
        			<td><input type='text' value='<?php echo e($form["label"]); ?>' placeholder="Input field label" onclick='showColumnSuggest(this)' onkeyup="showColumnSuggestLike(this)" class='form-control labels' name='label[]'/></td>
        			<td><input type='text' value='<?php echo e($form["name"]); ?>' placeholder="Input field name" onclick='showNameSuggest(this)' onkeyup="showNameSuggestLike(this)" class='form-control name' name='name[]'/></td>
        			<td><input type='text' value='<?php echo e($form["type"]?:"text"); ?>' placeholder="Input field type" onclick='showTypeSuggest(this)' onkeyup="showTypeSuggestLike(this)" class='form-control type' name='type[]'/></td>        			
        			<td><input type='text' value='<?php echo e($form["validation"]); ?>' class='form-control validation' onclick="showValidationSuggest(this)" onkeyup="showValidationSuggestLike(this)" name='validation[]' value='required' placeholder='Enter Laravel Validation'/></td>        			
        			<td>     			
        				...
        				<div class='option_area' style="display: none">
        					...
        					?>
                                            <div class="form-group">
                                                ...
                                                <?php $__currentLoopData = $val->enum; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enum): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <input type="radio" name="option[<?php echo e($index); ?>][<?php echo e($key); ?>]" <?php echo e(($enum == $value)?"checked":""); ?> value="<?php echo e($enum); ?>"> <?php echo e($enum); ?>
                                        ...
                                        <?php else:?>
            	        					...
            	        					<div class="form-group">
            	        						<label><?php echo e($key); ?></label>
            								    <input type="text" name="option[<?php echo e($index); ?>][<?php echo e($key); ?>]" placeholder="<?php echo e($val->placeholder); ?>" value="<?php echo e($value); ?>" class="form-control">
            	        					</div>
                                        <?php endif;?>
                                    <?php else:?>
        					...
        					?>
	        					<div class="form-group">
									...
									<?php if(is_object($val) && property_exists($val, 'type') && $val->type == 'textarea'): ?>
										<textarea type="text" name="option[<?php echo e($index); ?>][<?php echo e($key); ?>]" placeholder="<?php echo e($val->placeholder); ?>" class="form-control"><?php echo e($value); ?></textarea>
									<?php else: ?>
										<input type="text" name="option[<?php echo e($index); ?>][<?php echo e($key); ?>]" placeholder="<?php echo e($val); ?>" value="<?php echo e($value); ?>" class="form-control">
									<?php endif; ?>
								</div>
