...
<ul class="nav nav-tabs">
  ...
  <li role="presentation" class="active"><a href="<?php echo e(Route('ModulsControllerGetStep2',['id'=>$id])); ?>"><i class='fa fa-table'></i> Step 2 - Table Display</a></li>
  <li role="presentation"><a href="<?php echo e(Route('ModulsControllerGetStep3',['id'=>$id])); ?>"><i class='fa fa-plus-square-o'></i> Step 3 - Form Display</a></li>
...
<script>
    ...
    var tables = <?php echo json_encode($table_list); ?>;
    ...
    function showTableFieldLike(t) {
        ...
        $.get("<?php echo e(CRUDBooster::mainpath('table-columns')); ?>/"+table,function(response) { 
            t.next("ul").remove();                              
            var list = '';
...
<div class="box box-default">
    ...
    <div class="alert alert-info">
        <strong>Warning</strong>. Make sure that your column format are normally, unless using this Tool maybe make your current configuration broken, because this Tool will replace your configuration.
    </div>

    <form method="post" action="<?php echo e(Route('ModulsControllerPostStep3')); ?>">
        ...
        <table class="table-display table table-striped">
            ...
            <tbody>
                <?php if($cb_col): ?>
                <?php $__currentLoopData = $cb_col; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><input value='<?php echo e($c["label"]); ?>' type='text' name='column[]' onclick='showColumnSuggest(this)' onKeyUp='showColumnSuggestLike(this)' placeholder='Column Name' class='column form-control notfocus' value=''/></td>
                        <td><input value='<?php echo e($c["name"]); ?>' type='text' name='name[]' onclick='showNameSuggest(this)' onKeyUp='showNameSuggestLike(this)' placeholder='Field Name' class='name form-control notfocus' value=''/></td>
                        <td><input value='<?php echo e(@explode(",",$c["join"])[0]); ?>' type='text' name='join_table[]' onclick='showTable(this)' onKeyUp='showTableLike(this)' placeholder='Table Name' class='join_table form-control notfocus' value=''/></td>
                        <td><input value='<?php echo e(@explode(",",$c["join"])[1]); ?>' type='text' name='join_field[]' onclick='showTableField(this)' onKeyUp='showTableFieldLike(this)' placeholder='Field Name Shown' class='join_field form-control notfocus' value=''/></td>
                        <td><input type='text' name='callbackphp[]' class='form-control callbackphp notfocus' value='<?php echo e($c["callback_php"]); ?>' placeholder="Optional" /></td>
                        <td><input value='<?php echo e($c["width"]?:0); ?>' type='number' name='width[]' class='form-control'/></td>
                        <td>
                            <select class='form-control is_image' name='is_image[]'>
                                <option <?php echo e((!$c['image'])?"selected":""); ?> value='0'>N</option>
                                <option <?php echo e(($c['image'])?"selected":""); ?> value='1'>Y</option>
                            </select> 
                        </td>
                        <td>
                            <select class='form-control is_download' name='is_download[]'>
                                <option <?php echo e((!$c['download'])?"selected":""); ?> value='0'>N</option>
                                <option <?php echo e(($c['download'])?"selected":""); ?> value='1'>Y</option>
                            </select> 
                        </td>
                        <td>
                ...
                <tr id="tr-sample" style="display:none">
                    ...
                    <td><input type='text' name='join_table[]' onclick='showTable(this)' onKeyUp='showTableLike(this)' placeholder='Table Name' class='join_table form-control notfocus' value=''/></td>
                    <td><input type='text' name='join_field[]' onclick='showTableField(this)' onKeyUp='showTableFieldLike(this)' placeholder='Field Name Shown' class='join_field form-control notfocus' value=''/></td>
    ...
    <div class="box-footer">
        <div align="right">
            <button type="button" onclick="location.href='<?php echo e(CRUDBooster::mainpath('step1').'/'.$id); ?>'" class="btn btn-default">&laquo; Back</button>
