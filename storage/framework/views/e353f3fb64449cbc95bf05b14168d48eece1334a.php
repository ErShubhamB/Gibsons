...
<ul class="nav nav-tabs">
  ...
  <li role="presentation" class="active"><a href="<?php echo e(Route('ModulsControllerGetStep4',['id'=>$id])); ?>"><i class='fa fa-wrench'></i> Step 4 - Configuration</a></li>
</ul>
			...
			<div class="col-sm-4">
				<div class="row">
					...
					<div class="form-group">
						...
						<label class='radio-inline'>
							<input <?php echo e(($cb_button_action_style=='button_icon')?"checked":""); ?> type='radio' name='button_action_style' value='button_icon'/> Icon
						</label>
						<label class='radio-inline'>
							<input <?php echo e(($cb_button_action_style=='button_icon_text')?"checked":""); ?> type='radio' name='button_action_style' value='button_icon_text'/> Icon & Text
						</label>
						<label class='radio-inline'>
							<input <?php echo e(($cb_button_action_style=='button_text')?"checked":""); ?> type='radio' name='button_action_style' value='button_text'/> Button Text
						</label>
						<label class='radio-inline'>
							<input <?php echo e(($cb_button_action_style=='button_dropdown')?"checked":""); ?> type='radio' name='button_action_style' value='button_dropdown'/> Dropdown
						</label>
					</div>
					</div>
