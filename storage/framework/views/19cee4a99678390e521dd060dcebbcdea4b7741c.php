<?php $__env->startSection('content'); ?>
        ...
        <div class="panel panel-default">
           <div class="panel-heading">
             <strong><i class='<?php echo e(CRUDBooster::getCurrentModule()->icon); ?>'></i> <?php echo $page_title or "Page Title"; ?></strong>
           </div> 
                ...
                <?php endif; ?>
                        <div class="box-body" id="parent-form-area">
                          ...
                          <?php if($command == 'detail'): ?>
                             <?php echo $__env->make("crudbooster::default.form_detail", \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>  
                          <?php else: ?>
                             <?php echo $__env->make("crudbooster::default.form_body", \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>         
                          <?php endif; ?>
                        </div><!-- /.box-body -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <?php if($button_cancel && CRUDBooster::getCurrentMethod() != 'getDetail'): ?>                       
                                <?php if(g('return_url')): ?>
                                <a href='<?php echo e(g("return_url")); ?>' class='btn btn-default'><i class='fa fa-chevron-circle-left'></i> <?php echo e(trans("crudbooster.button_back")); ?></a>
                                <?php else: ?> 
                                <a href='<?php echo e(CRUDBooster::mainpath("?".http_build_query(@$_GET))); ?>' class='btn btn-default'><i class='fa fa-chevron-circle-left'></i> <?php echo e(trans("crudbooster.button_back")); ?></a>
                                <?php endif; ?>
                              <?php endif; ?>
