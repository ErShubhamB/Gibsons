...
<li class="dropdown">
	<a href="" class="dropdown-toggle no-after peers fxw-nw ai-c lh-1" data-toggle="dropdown">
		<div class="peer mR-10">
			@if(Auth::user()->avatar != '')
			<img class="w-2r bdrs-50p" src="/uploads/{{Auth::user()->avatar}}" alt="">
			...
			<div class="peer">
				<span class="fsz-sm c-grey-900 d-none d-sm-block">{{Auth::user()->name}}</span>
			</div>
		</a>
		<ul class="dropdown-menu fsz-sm">
			
			<li>
				<a href="{{route('user-profile')}}" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700">
