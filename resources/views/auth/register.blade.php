...
<div class="peers ai-s fxw-nw h-100vh">
    <div class="peer peer-greed h-100 pos-r bgr-n bgpX-c bgpY-c bgsz-cv" style="background-image:url('{{asset('images/gst-bg.png')}}')">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="peers ai-c jc-sb fxw-nw">
                                        ...
                                        <div class="peers ai-c jc-sb fxw-nw">
                                                <div class="peer">
                                                    <span class="peer peer-greed">Already a Member? <a href="{{route('login')}}">Login</a></span>
                                                </div>
                                            </div>
                                    </div>
                                </form>
